...
for i = 1:lenT-1
    ...
    [ delta_(i), Fx_(i) ] = me227_controller( s_(i), e_(i), dpsi_(i), Ux_(i), Uy_(i), r_(i), gains, control_mode, path);
    
    % Take simulation step
    [Ux_(i+1), Uy_(i+1), r_(i+1), s_(i+1), e_(i+1), dpsi_(i+1)] = simulate_step(Ux_(i), Uy_(i), r_(i), s_(i), e_(i), dpsi_(i),...
