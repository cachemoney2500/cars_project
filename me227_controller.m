...
K_radpmps2 = veh.Wf/(g*f_tire.Ca_lin)-veh.Wr/(g*r_tire.Ca_lin); % [rad/m/s^2]
%%% END STUDENT CODE
...
if control_mode == 1
    %%% STUDENT CODE HERE
    % Feedback only
    delta = -K_la*(e+x_la*dpsi)/f_tire.Ca_lin;
    ...
    delta_ff = K_la*x_la/f_tire.Ca_lin*dpsi_ss+kappa*(veh.L+K_radpmps2*Ux^2);
